      ...
      <div className="max-w-4xl mx-auto space-y-8">
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground text-lg">
            Convert images with tables to Excel spreadsheets using OCR.
          </p>
        </div>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-sm text-muted-foreground mt-2">
                Tip: For best results, upload images with clear table structures.
                The converter will automatically detect columns and rows.
              </p>
            </CardContent>
          </Card>
        )}
        ...
        <div className="grid md:grid-cols-3 gap-6 pt-8">
          <FeatureCard
            ...
            description="Automatically detect and parse tables from images into spreadsheet format."
          />
          <FeatureCard
            title="Multiple Formats"
            description="Support JPG, PNG, GIF and other common image formats."
          />
          <FeatureCard
            title="Instant Download"
            description="Download results as Excel (.xlsx) file instantly."
          />
        </div>
      </div>
    </div>
